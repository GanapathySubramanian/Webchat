...
<!--setting page list-->
				<div class="row compose-sideBar">
		            ...
		            <div style="margin-top:50px;margin-left:130px;"class="col-sm-9 col-xs-9 sideBar-main">
						...
						<a style="text-decoration:none;color:black;"href="whatsapp.com://send?text= Please Check This"> Invite Your Friends</a>
                    </div>
...
<!--Inside the Accounts-->
	...
	<div class='side-three'id="deleteacc">	
         <div style="background-color:#048dfe;" class="row newMessage-heading">
			...
			<div class="box">
            <form method="POST" action="include/delete.php" autocomplete="off">
            <br><br>
		...
		<div class='side-three'id="chat-wallpaper">	
            <div style="background-color:#048dfe;" class="row newMessage-heading">
				...
				<div class="cont1">
				    <a href='chatpage.php?color=fff'><div class="box1"   onmouseover="document.getElementById('conversation').style.backgroundColor = '#fff';" ></div></a>
                    <a href='chatpage.php?color=b3ffff'><div class="box2" onmouseover="document.getElementById('conversation').style.backgroundColor = '#b3ffff';"></div></a>
                    <a href='chatpage.php?color=e0e0eb'><div class="box3" onmouseover="document.getElementById('conversation').style.backgroundColor='#e0e0eb';"></div></a>
				</div>
				<div class="cont2">
                    <a href='chatpage.php?color=f2ccff' ><div class="box4" onmouseover="document.getElementById('conversation').style.backgroundColor='#f2ccff';"></div></a>
                    <a href='chatpage.php?color=f2f2f2' ><div class="box5" onmouseover="document.getElementById('conversation').style.backgroundColor='#f2f2f2';"></div></a>
                    <a href='chatpage.php?color=d6d6f5' ><div class="box6"onmouseover="document.getElementById('conversation').style.backgroundColor='#d6d6f5';"></div>
                    </a>
				</div>
				<div class="cont3">
                    <a href='chatpage.php?color=ffe6f9' ><div class="box7" onmouseover="document.getElementById('conversation').style.backgroundColor='#ffe6f9';"></div></a>
                     <a href='chatpage.php?color=ffb3b3' ><div class="box8" onmouseover="document.getElementById('conversation').style.backgroundColor='#ffb3b3';"></div></a>
                     <a href='chatpage.php?color=98F5B1' ><div class="box9" onmouseover="document.getElementById('conversation').style.backgroundColor='#98F5B1';"></div></a>
		        </div>
				<div class="cont4">
                    <a href='chatpage.php?color=799fcb' ><div class="box10" onmouseover="document.getElementById('conversation').style.backgroundColor='#799fcb';"></div></a>
                     <a href='chatpage.php?color=ecddd0' ><div class="box11" onmouseover="document.getElementById('conversation').style.backgroundColor='#ecddd0';"></div></a>
                     <a href='chatpage.php?color=f9665e' ><div class="box12" onmouseover="document.getElementById('conversation').style.backgroundColor='#f9665e';"></div></a>
		        </div>
		</div>
...
if (isset ($_GET['user_name'])) { ?>
 ...
 (Sender_username ='$user_name' AND Receiver_username ='$clicked_name') ORDER BY msg_id ASC";
                   ...
                   <div class="row emoji" id="emoji" style="display:none;">
						...
						<div class="tab-content " id="myTabContent">
						  ...
						  <font face="Segoe UI Symbol"></font>
							<a onclick="getEmoji(this)"><font face="Arial">&#x1f604;</font></a>
